...
const UI = {
  ...
  landingHeroTitle: L(
    "Learn to Care for Animals Better — At Your Own Pace",
    "పశువులను మరింత మెరుగ్గా చూసుకోవడం నేర్చుకోండి — మీ స్వంత వేగంతో",
    "விலங்குகளை சிறப்பாகக் கவனிக்கக் கற்றுக்கொள்ளுங்கள் — உங்கள் சொந்த வேகத்தில்",
    "ಪ್ರಾಣಿಗಳನ್ನು ಉತ್ತಮವಾಗಿ ಆರೈಕೆ ಮಾಡಲು ಕಲಿಯಿರಿ — ನಿಮ್ಮ ಸ್ವಂತ ವೇಗದಲ್ಲಿ"
  ),
  landingHeroSubtitle: L(
    "A free, self-paced training course for veterinarians and para-vets working with dairy animals. No instructor needed — learn step by step, in the language you're most comfortable with.",
    "పాడి పశువులతో పనిచేసే పశువైద్యులు మరియు పారా-వెట్‌ల కోసం ఉచిత, స్వీయ-వేగ శిక్షణ కోర్సు. బోధకుడు అవసరం లేదు — మీకు సౌకర్యవంతమైన భాషలో, దశలవారీగా నేర్చుకోండి.",
    "பால் கால்நடைகளுடன் பணிபுரியும் கால்நடை மருத்துவர்கள் மற்றும் பாரா-வெட் ஊழியர்களுக்கான இலவச, சுய-வேக பயிற்சி பாடநெறி. பயிற்சியாளர் தேவையில்லை — உங்களுக்கு வசதியான மொழியில், படிப்படியாக கற்றுக்கொள்ளுங்கள்.",
    "ಹೈನು ಪ್ರಾಣಿಗಳೊಂದಿಗೆ ಕೆಲಸ ಮಾಡುವ ಪಶುವೈದ್ಯರು ಮತ್ತು ಪ್ಯಾರಾ-ವೆಟ್‌ಗಳಿಗಾಗಿ ಉಚಿತ, ಸ್ವಯಂ-ವೇಗದ ತರಬೇತಿ ಕೋರ್ಸ್. ತರಬೇತುದಾರ ಅಗತ್ಯವಿಲ್ಲ — ನಿಮಗೆ ಆರಾಮದಾಯಕವಾದ ಭಾಷೆಯಲ್ಲಿ, ಹಂತ ಹಂತವಾಗಿ ಕಲಿಯಿರಿ."
  ),
  ...
  landingFeature1Text: L(
    "From spotting a sick animal early to vaccination, common diseases, mastitis, breeding, and safe traditional remedies.",
    "పశువులో అనారోగ్యాన్ని ముందుగానే గుర్తించడం నుండి టీకాలు, సాధారణ వ్యాధులు, పొదుగు వ్యాధులు (మాస్టిటిస్), సంతానోత్పత్తి, సురక్షితమైన సంప్రదాయ చికిత్సల వరకు.",
    "ஒரு விலங்கு உடல்நலக்குறைவை முன்கூட்டியே கண்டறிவது முதல் தடுப்பூசி, பொதுவான நோய்கள், மடி வீக்கம், இனப்பெருக்கம், பாதுகாப்பான பாரம்பரிய சிகிச்சைகள் வரை.",
    "ಅನಾರೋಗ್ಯದ ಪ್ರಾಣಿಯನ್ನು ಬೇಗನೆ ಗುರುತಿಸುವುದರಿಂದ ಹಿಡಿದು ಲಸಿಕೆ, ಸಾಮಾನ್ಯ ರೋಗಗಳು, ಕೆಚ್ಚಲು ಬಾವು, ಸಂತಾನೋತ್ಪತ್ತಿ ಮತ್ತು ಸುರಕ್ಷಿತ ಸಾಂಪ್ರದಾಯಿಕ ಚಿಕಿತ್ಸೆಗಳವರೆಗೆ."
  ),
